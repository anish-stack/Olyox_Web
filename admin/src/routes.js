...
import UploadVendorAdditionDocument from './views/Vendor/UploadVendorAdditionDocument'
...
const routes = [
  ...
  { path: '/update-vendor-addition-documents/:id', name: 'Updat Vendor Addition Document', element: UploadVendorAdditionDocument },
