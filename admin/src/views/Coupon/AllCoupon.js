...
const AllCoupon = () => {
    ...
    const fetchCoupons = async () => {
        setLoading(true);
        try {
            const { data } = await axios.get('http://localhost:3100/api/v1/admin/all_getCoupon');
    ...
    const handleUpdateStatus = async (id, currentStatus) => {
        ...
        try {
            ...
            const res = await axios.put(`http://localhost:3100/api/v1/admin/updateCouponStatus/${id}`, {
    ...
    const handleDeleteCoupon = async (id) => {
        setLoading(true);
        try {
            const res = await axios.delete(`http://localhost:3100/api/v1/admin/deleteCoupon/${id}`);
            toast.success(res?.data?.message);
            fetchCoupons();
        } catch (error) {
