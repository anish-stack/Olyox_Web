...
const EditCoupon = () => {
    ...
    useEffect(() => {
        const fetchCoupon = async () => {
            try {
                const res = await axios.get(`http://www.appapi.olyox.com/api/v1/admin/getSingleCoupon/${id}`);
                setFormData({
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await axios.put(`http://www.appapi.olyox.com/api/v1/admin/updateCoupon/${id}`, formData);
