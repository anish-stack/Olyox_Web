...
function ParcelDetail() {
    ...
    const fetchVendorDetails = async () => {
        ...
        try {
            ...
            const { data } = await axios.get(`http://www.appapi.olyox.com/api/v1/parcel/get_single_parcel/${id}`);
            setVendor(data.data);
        } catch (error) {
    ...
    const handleDocumentVerifyToggle = async (id, status) => {
        // In a real implementation, you would use axios like this:
        try {
          const res = await axios.put(`http://www.appapi.olyox.com/api/v1/parcel/update_parcel_document_verify/${id}`, {
