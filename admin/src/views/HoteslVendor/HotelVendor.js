...
const HotelVendor = () => {
    ...
    const handleStatusToggle = async (id,status) => {
        ...
        try {
            const res = await axios.put(`http://www.appapi.olyox.com/api/v1/hotels/update_hotel_block_status/${id}`,{
    ...
    const handleDocumentVerifiedToggle = async (id,DocumentUploadedVerified) => {
        ...
        try {
            const res = await axios.put(`http://www.appapi.olyox.com/api/v1/hotels/verify_hotel_documents/${id}`,{
