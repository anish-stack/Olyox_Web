...
const HotelVendor = () => {
    ...
    const fetchHotelDetails = async () => {
        ...
        try {
            const { data } = await axios.get(`https://www.appapi.olyox.com/api/v1/hotels/get_hotelbyId/${id}`);
            setHotel(data.data);
        } catch (error) {
    ...
    const handleStatusToggle = async (id,status) => {
        ...
        try {
            const res = await axios.put(`https://www.appapi.olyox.com/api/v1/hotels/update_hotel_block_status/${id}`,{
    ...
    const handleDocumentVerifiedToggle = async (id,DocumentUploadedVerified) => {
        ...
        try {
            const res = await axios.put(`https://www.appapi.olyox.com/api/v1/hotels/verify_hotel_documents/${id}`,{
