...
const TiffinBooking = () => {
    ...
    const fetchOrders = async () => {
        setLoading(true);
        try {
            const { data } = await axios.get('http://www.appapi.olyox.com/api/v1/tiffin/get_all_orders');
    ...
    const handleDelete = async (vendorId) => {
        try {
            const res = await axios.delete(`http://www.appapi.olyox.com/api/v1/tiffin/delete_tiffin_order/${vendorId}`);
    ...
    const handleUpdateOrderStatus = async (orderId, status) => {
        try {
            const res = await axios.put(`http://www.appapi.olyox.com/api/v1/tiffin/update_tiffin_order_status/${orderId}`, { status });
            toast.success(res.data.message);
