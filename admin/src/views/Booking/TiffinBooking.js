...
const TiffinBooking = () => {
    ...
    const handleDelete = async (vendorId) => {
        try {
            const res = await axios.delete(`https://demoapi.olyox.com/api/v1/tiffin/delete_tiffin_order/${vendorId}`);
    ...
    const handleUpdateOrderStatus = async (orderId, status) => {
        try {
            const res = await axios.put(`https://demoapi.olyox.com/api/v1/tiffin/update_tiffin_order_status/${orderId}`, { status });
            toast.success(res.data.message);
