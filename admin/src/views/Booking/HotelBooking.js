...
const HotelBooking = () => {
    ...
    const handleDelete = async (vendorId) => {
        try {
            const res = await axios.delete(`https://demoapi.olyox.com/api/v1/hotels/delete_hotel_order/${vendorId}`);
    ...
    const handleUpdateOrderStatus = async (orderId, status) => {
        try {
            const res = await axios.put(`https://demoapi.olyox.com/api/v1/hotels/update_status_hotel_order/${orderId}`, { status });
            toast.success(res.data.message);
