...
const HotelBooking = () => {
    ...
    const fetchOrders = async () => {
        ...
        try {
            const { data } = await axios.get('http://www.appapi.olyox.com/api/v1/hotels/get_all_hotel_booking');
    ...
    const handleDelete = async (vendorId) => {
        try {
            const res = await axios.delete(`http://www.appapi.olyox.com/api/v1/hotels/delete_hotel_order/${vendorId}`);
    ...
    const handleUpdateOrderStatus = async (orderId, status) => {
        try {
            const res = await axios.put(`http://www.appapi.olyox.com/api/v1/hotels/update_status_hotel_order/${orderId}`, { status });
            toast.success(res.data.message);
