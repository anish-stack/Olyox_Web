      ...
      return (
          <>
              {loading ? (
                  ...
                  <Table
                      heading="All Bike Plans"
                      btnText="Add New Plan"
                      btnURL="/subscription/add-bike"
                          ...
                          <CTableRow key={item._id}>
                              ...
                              <CTableDataCell>
                                  <div className="action-parent">
                                      <CNavLink href={`#subscription/edit-bike/${item._id}`} className="edit">
...
export default AllBikeSubscription
