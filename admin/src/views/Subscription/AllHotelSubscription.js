    ...
    return (
        <>
            {loading ? (
                ...
                <Table
                    heading="All Hotel Plans"
                    btnText="Add New Plan"
                    btnURL="/subscription/add-hotel"
                        ...
                        <CTableRow key={item._id}>
                            ...
                            <CTableDataCell>
                                <div className="action-parent">
                                    <CNavLink href={`#subscription/edit-hotel/${item._id}`} className="edit">
...
export default AllHotelSubscription
