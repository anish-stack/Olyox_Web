...
const EditTransportSubscription = () => {
    ...
    useEffect(() => {
        const fetchMembershipPlan = async () => {
            try {
                ...
                const res = await axios.get(`http://www.webapi.olyox.com/api/v1//membership-plans/${id}`);
                setFormData({
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await axios.put(`http://www.webapi.olyox.com/api/v1//membership-plans/${id}`, formDataToSend);
    ...
    return (
        <Form
            heading="Edit Transport Plan"
            btnText="Back"
            btnURL="/subscription/all_transport"
...
export default EditTransportSubscription
