...
const AddTransportSubscription = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await axios.post('https://api.olyox.com/api/v1/membership-plans-create', formDataToSend);
...
export default AddTransportSubscription
