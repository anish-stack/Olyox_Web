...
const AllTiffinVendor = () => {
    ...
    const fetchVendors = async () => {
        ...
        try {
            ...
            const { data } = await axios.get('http://www.appapi.olyox.com/api/v1/tiffin/get_restaurant');
    ...
    const handleStatusToggle = async (vendorId, currentStatus) => {
        setLoading(true);
        try {
            await axios.put(`http://www.appapi.olyox.com/api/v1/tiffin/update_restaurant_status/${vendorId}`, {
    ...
    const handleDelete = async (vendorId) => {
        try {
            const res = await axios.delete(`http://www.appapi.olyox.com/api/v1/tiffin/delete_tiffin_vendor/${vendorId}`);
