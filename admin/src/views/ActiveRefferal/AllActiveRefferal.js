...
function AllActiveRefferal() {
    ...
    const handleFetchReferrals = async () => {
        setLoading(true);
        try {
            const { data } = await axios.get('https://olyox.digital4now.in/api/v1/get-all-referral');
    ...
    const heading = ['S.No', 'Reffered By', 'Name', 'Contact Number', 'State', 'Is Registered', 'Is Recharge'];
