...
const Onboarding = () => {
    ...
    const fetchSlides = async () => {
        setLoading(true);
        try {
            const { data } = await axios.get('http://www.appapi.olyox.com/api/v1/admin/get_onboarding_slides');
    ...
    const handleDeleteSlide = async () => {
        setLoading(true);
        try {
            await axios.delete(`http://www.appapi.olyox.com/api/v1/admin/delete_onboarding_slide/${selectedSlideId}`);
