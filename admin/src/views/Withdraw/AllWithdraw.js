...
function AllWithdraw() {
    ...
    const fetchWithdrawals = async () => {
        ...
        try {
            ...
            const { data } = await axios.get('https://www.api.olyox.com/api/v1/withdrawals');
    ...
    const handleApproveWithdrawal = async () => {
        ...
        try {
            ...
            const res = await axios.put(
                `https://www.api.olyox.com/api/v1/approve-withdrawal/${selectedWithdrawalId}`,
    ...
    const handleCancelWithdrawal = async () => {
        ...
        setLoading(true);
        try {
            const res = await axios.put(`https://www.api.olyox.com/api/v1/reject-withdrawal/${selectedWithdrawalId}`, {
                cancelReason
            });
            toast.success(res?.data?.message);
            fetchWithdrawals();
