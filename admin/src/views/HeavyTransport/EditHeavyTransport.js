...
const EditHeavyTransport = () => {
    ...
    const fetchHeavyTitles = async () => {
        try {
            const res = await axios.get('http://www.appapi.olyox.com/api/v1/heavy/heavy-category');
    ...
    const handleFetchData = async () => {
        try {
            const res = await axios.get(`http://www.appapi.olyox.com/api/v1/admin/get-single-heavy/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await axios.put(`http://www.appapi.olyox.com/api/v1/admin/update-heavy/${id}`, formDataToSend, {
