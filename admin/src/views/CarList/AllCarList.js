...
function AllCarList() {
    ...
    const fetchRides = async () => {
        setLoading(true);
        try {
            const { data } = await axios.get('http://www.appapi.olyox.com/api/v1/admin/getAllSuggestions');
    ...
    const handleDeleteRide = async () => {
        setLoading(true);
        try {
            await axios.delete(`http://www.appapi.olyox.com/api/v1/admin/deleteSuggestion/delete/${selectedRideId}`);
    ...
    const handleStatusToggle = async (rideId, currentStatus) => {
        setLoading(true);
        try {
            await axios.put(`http://www.appapi.olyox.com/api/v1/admin/updateSuggestionStatus/${rideId}`, {
